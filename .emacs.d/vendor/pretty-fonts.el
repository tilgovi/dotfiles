;;; pretty-fonts.el --- Pretty ligature support for Emacs

;; Copyright (C) 2016-2017 Eric Kaschalk

;; Author Erik Kaschalk <ekaschalk@gmail.com>

;; Keywords font, ligature

;;; Commentary:

;; This package sets up ligature substitution with the Fira Code Font.
...
(defconst pretty-fonts-fira-font
  '(;; OPERATORS
    ...
    ;; Direct
    ("\\(->\\)"  #Xe114) ("\\(=>\\)"  #Xe13f)
    ("\\(<-\\)"  #Xe152) ;; ("\\(<=\\)"  #Xe157) <- appears to be broken
    ("\\(-->\\)" #Xe113) ("\\(->>\\)" #Xe115)
    ("\\(==>\\)" #Xe13e) ("\\(=>>\\)" #Xe140)
    ("\\(<--\\)" #Xe153) ("\\(<<-\\)" #Xe15d)
    ("\\(<==\\)" #Xe158) ("\\(<<=\\)"  #Xe15e)
