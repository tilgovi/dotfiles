(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ace-window add-node-modules-path auto-virtualenv cargo chruby color-theme-solarized company company-anaconda company-go company-jedi company-quickhelp company-tern cython-mode diminish dockerfile-mode editorconfig elpy erlang flow-minor-mode flycheck flycheck-mypy flycheck-rust geiser gitconfig-mode gitignore-mode google-c-style gotest helm helm-core import-js jedi json-mode less-css-mode magit magit-popup markdown-mode multiple-cursors nginx-mode py-yapf pylint python racer rainbow-delimiters rainbow-mode robe rust-mode rustfmt smart-mode-line smartparens smex solarized-theme tern terraform-mode theme-changer toml-mode typescript-mode undo-tree use-package web-mode whitespace-cleanup-mode yaml-mode yasnippet zencoding-mode)))
